...
2.noun:`$ python3 json2noun.py` verb:`$ python3 json2noun.py -F 動詞` wakati:`$ python3 json2noun.py -F ""`  
x.if you need dataset as one_file → `$ cat ./wikinoun/*.txt > wikinoun.txt`  
